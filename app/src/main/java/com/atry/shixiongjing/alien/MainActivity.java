...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Add the button and the textureView from the main content xml file
    ...
    private void createCameraPreview(){
       try{
           ...
           //Need createReprocessableCaptureSession() instead of createCaptureSession()
    ...
    private void openCamera() {
        ...
        try{
            ...
            //check real time permission if run higher than API 23
